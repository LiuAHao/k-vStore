...
PROTOBUF_NAMESPACE_OPEN
template<> ::kvstore::MyRequest* Arena::CreateMaybeMessage<::kvstore::MyRequest>(Arena*);
template<> ::kvstore::MyResponse* Arena::CreateMaybeMessage<::kvstore::MyResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace kvstore {
...
class MyRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kvstore.MyRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:kvstore.MyRequest)
 private:
  class _Internal;
...
class MyResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kvstore.MyResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:kvstore.MyResponse)
 private:
  class _Internal;
...
inline const std::string& MyRequest::name() const {
  // @@protoc_insertion_point(field_get:kvstore.MyRequest.name)
...
void MyRequest::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.MyRequest.name)
}
inline std::string* MyRequest::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:kvstore.MyRequest.name)
  return _s;
}
...
inline std::string* MyRequest::release_name() {
  // @@protoc_insertion_point(field_release:kvstore.MyRequest.name)
...
inline void MyRequest::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kvstore.MyRequest.name)
}
...
inline const std::string& MyResponse::message() const {
  // @@protoc_insertion_point(field_get:kvstore.MyResponse.message)
  return _internal_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MyResponse::set_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kvstore.MyResponse.message)
}
inline std::string* MyResponse::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:kvstore.MyResponse.message)
  return _s;
}
...
inline std::string* MyResponse::release_message() {
  // @@protoc_insertion_point(field_release:kvstore.MyResponse.message)
  return _impl_.message_.Release();
}
inline void MyResponse::set_allocated_message(std::string* message) {
  if (message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kvstore.MyResponse.message)
}
